...
Trajectory TrajectoryGenerator::StayInLane2(Map map, CarState car_state) {
  ...
  int num_points_traveled = 50 - previous_path_size;
  ...
  if (previous_path_size == 0) {
    ...
    s = previous_s_vals[keep_path_amount - 1 + num_points_traveled];
    d = previous_d_vals[keep_path_amount - 1 + num_points_traveled];
  }
